...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carsAppDatabase = Room.databaseBuilder(this, CarsAppDatabase.class, "CarsDB").build();
    ...
    public void addAndEditCars(final boolean isUpdate, final Car car, final int position) {
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isUpdate && car != null) updateCar(nameEditText.getText().toString(), priceEditText.getText().toString(), position);
                else createCar(nameEditText.getText().toString(), priceEditText.getText().toString());
            }
        });
    }
    ...
    private void createCar(String name, String price) { new CreateCarAsyncTask().execute(new Car(0, name, price)); }
    ...
    private class CreateCarAsyncTask extends AsyncTask<Car, Void, Void>{
        ...
        protected Void doInBackground(Car... cars) {
            ...
            if (car != null) carArrayList.add(0, car);
            return null;
        }
